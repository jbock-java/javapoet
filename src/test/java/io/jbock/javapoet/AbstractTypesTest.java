...
public abstract class AbstractTypesTest {
  ...
  public void getBasicTypeMirror() {
    Assertions.assertEquals(ClassName.get(Object.class), TypeName.get(getMirror(Object.class)));
    Assertions.assertEquals(ClassName.get(Charset.class), TypeName.get(getMirror(Charset.class)));
    Assertions.assertEquals(ClassName.get(AbstractTypesTest.class), TypeName.get(getMirror(AbstractTypesTest.class)));
  }
