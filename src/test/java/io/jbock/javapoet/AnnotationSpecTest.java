...
public final class AnnotationSpecTest {
  ...
  public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "import io.jbock.javapoet.AnnotationSpecTest;\n"
  ...
  public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("io.jbock.javapoet", typeBuilder.build()).build();
  ...
  public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@io.jbock.javapoet.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
        .isEqualTo(
            "@io.jbock.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                + "n = {}, m = {}"
                + ")");
  }
  ...
  public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@io.jbock.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = io.jbock.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@io.jbock.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = {"
            + "io.jbock.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", io.jbock.javapoet.AnnotationSpecTest.Breakfast.WAFFLES"
            + ", io.jbock.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + "})");
  ...
  public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@io.jbock.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "o = io.jbock.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", p = 1701"
            + ", f = 11.1"
            + ", m = {9, 8, 1, 123}"
            + ", l = java.lang.Override.class"
            + ", j = @io.jbock.javapoet.AnnotationSpecTest.AnnotationA"
            + ", q = @io.jbock.javapoet.AnnotationSpecTest.AnnotationC(\"bar\")"
